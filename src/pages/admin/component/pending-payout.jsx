...
export function PendingPayouts({ payouts }) {
  ...
  const confirmApproval = async () => {
    ...
    await submitApproval({formData, userId});
  };
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h3 className="font-medium text-white">
                            Dr. {payout.doctorId.name}
                          </h3>
                          <p className="text-sm text-muted-foreground">
                            {payout.doctorId.specialty}
                          </p>
        ...
        <Dialog open={!!selectedPayout} onOpenChange={closeDialogs}>
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-6 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-white">
                      Dr. {selectedPayout.doctorId.name}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">
                    ...
                    <p className="text-white">{selectedPayout.doctorId.email}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">
                      Specialty
                    ...
                    <p className="text-white">
                      {selectedPayout.doctorId.specialty}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">
                    ...
                    <p className="text-white">
                      {selectedPayout.doctorId.credits}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {selectedPayout.doctorId.credits < selectedPayout.credits && (
                <Alert variant="destructive">
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    Warning: Doctor currently has only{" "}
                    {selectedPayout.doctorId.credits} credits but this payout
                ...
                <AlertDescription>
                  ...
                  <ul className="mt-2 space-y-1 list-disc pl-4">
                    <li>
                      ...
                      {selectedPayout.doctorId.name}'s account
                    </li>
