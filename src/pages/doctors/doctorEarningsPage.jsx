...
// Replace these imports with your own UI components or shadcn/ui setup
...
export default function DoctorEarnings({ earnings, payouts = [] }) {
  ...
  const handlePayoutRequest = async (e) => {
    ...
    await submitPayoutRequest({userId, formData});
  };
